...
namespace Heimseiten\ContaoArticleWidthHeightBundle\ContaoManager;
...
class Plugin implements BundlePluginInterface
{
    ...
    {
        return [
            BundleConfig::create('Heimseiten\ContaoArticleWidthHeightBundle\HeimseitenContaoArticleWidthHeightBundle')
